...
namespace ArasProjectImporter
{
    class MpxjQuery
    {
        ...
        public static void listProjectHeader(ProjectFile file)
        {
        ...
        /// </summary>
        /// <param name="file">project file</param>
        public static void listResources(ProjectFile file)
        {
        ...
        /// </summary>
        /// <param name="file">project file</param>
        public static void listTasks(ProjectFile file)
        {
        ...
        /// </summary>
        /// <param name="file">project file</param>
        public static void listHierarchy(ProjectFile file)
        {
        ...
        public static void listHierarchy(Task task, String indent)
        {
        ...
        /// </summary>
        /// <param name="file">project file</param>
        public static void listAssignments(ProjectFile file)
        {
            Task task;
            Resource resource;
            String taskName;
        ...
        /// </summary>
        /// <param name="file">project file</param>
        public static void listAssignmentsByTask(ProjectFile file)
        {
            foreach (Task task in file.AllTasks.ToIEnumerable())
            {
        ...
        /// </summary>
        /// <param name="file">project file</param>
        public static void listAssignmentsByResource(ProjectFile file)
        {
            foreach (Resource resource in file.AllResources.ToIEnumerable())
            {
        ...
        /// </summary>
        /// <param name="file">project file</param>
        public static void listTaskNotes(ProjectFile file)
        {
            foreach (Task task in file.AllTasks.ToIEnumerable())
            {
        ...
        /// </summary>
        /// <param name="file">project file</param>
        public static void listResourceNotes(ProjectFile file)
        {
            foreach (Resource resource in file.AllResources.ToIEnumerable())
            {
        ...
        /// </summary>
        /// <param name="file">project file</param>
        public static void listRelationships(ProjectFile file)
        {
            foreach (Task task in file.AllTasks.ToIEnumerable())
            {
        ...
        /// </summary>
        /// <param name="file">project file</param>
        public static void listSlack(ProjectFile file)
        {
            foreach (Task task in file.AllTasks.ToIEnumerable())
            {
        ...
        /// </summary>
        /// <param name="file">project file</param>
        public static void listCalendars(ProjectFile file)
        {
